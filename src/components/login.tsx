...
<div id="wrapper">
    ...
    <div className="imges">
            <div className="phone">
 <img  className="imge50" src="https://www.instagram.com/static/images/homepage/screenshots/screenshot2-2x.png/80b8aebdea57.png"alt="" />
  <img className="imge51"  src="https://www.instagram.com/static/images/homepage/screenshots/screenshot4-2x.png/8e9224a71939.png"alt="" />
</div>
    </div>
    </div>
    <div>
  ...
  <div className="line"></div>
    ...
    <div className="sub-content">
        ...
        <div className="app">
        <h4 className="text-app">Get the app.</h4>
        <img className="img5" src="https://www.instagram.com/static/images/appstore-install-badges/badge_ios_english-en.png/180ae7a0bcf7.png" alt="" />
         <img className= "img55" src="https://www.instagram.com/static/images/appstore-install-badges/badge_android_english-en.png/e9cd846dc748.png" alt="" />
